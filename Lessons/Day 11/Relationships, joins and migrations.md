---
argument: SQL relationship and JOIN, migrations
section: database
lesson count: "2"
ex count: "2"
---
...
|------|---------|------------------------|
| 1 : 1 | Every row in A relates to **exactly one** row in B | Unique foreign key or sharing the same primary key |
| 1 : N | One row in A relates to **many** rows in B | B gets a **foreign key** referencing A |
| N : M | Many rows in A relate to **many** rows in B | A **junction table** holding two foreign keys |

#### 2. Example Schema
![[Relationships, joins and migrations - Example DB|1000]]

We’ll model a blogging platform:
...
Return each post with every tag attached:
...
3. Modify a query to return authors **without** posts tagged `"joins"` (hint: `LEFT JOIN` + `WHERE tag IS NULL`).  

### Migrations
https://github.com/boolean-uk/java-api-migrations-workshop.git

![[Repository/Day 11/Theory/1 - Migrations/README]]
## Exercises
### Relationships & JOINS in SQL
https://github.com/boolean-uk/java-apis-sql-relations-and-joins.git

![[Repository/Day 11/Ex/1 - SQL Relations & Joins/README]]
### Migrations
https://github.com/boolean-uk/java-api-migrations.git

![[Repository/Day 11/Ex/2 - Migrations/README]]